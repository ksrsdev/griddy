...
static const TeamBlueprint sTeamBlueprints[] = {
	...
	[TEAM_ORANGE] = {
		...
		.rosterSchema = {
			...
			[POSITION_HALF_BACK]        = {2, PLAYER_STAT_MOD_NONE},
			[POSITION_TIGHT_END]        = {1, PLAYER_STAT_MOD_NONE},
			[POSITION_WIDE_RECEIVER]    = {1, PLAYER_STAT_MOD_NONE},
			[POSITION_DEFENSIVE_TACKLE] = {1, PLAYER_STAT_MOD_NONE},
			[POSITION_DEFENSIVE_END]    = {2, PLAYER_STAT_MOD_NONE},
			[POSITION_LINE_BACKER]      = {3, PLAYER_STAT_MOD_NONE},
			[POSITION_DEFENSIVE_BACK]   = {5, PLAYER_STAT_MOD_NONE},
			[POSITION_KICKER]           = {1, PLAYER_STAT_MOD_NONE}
		}
	},
	[TEAM_BLUE] = {
